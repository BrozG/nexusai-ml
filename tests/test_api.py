...
USER_API_KEY = "sk_education_wikipedia_tes123"  # Wikipedia education key
...
def test_upload_file():
    ...
    test_content = b"Wikipedia is a free online encyclopedia created by volunteers worldwide. It contains millions of articles on various topics."
    
    files = {
        'file': ('test_wikipedia.txt', test_content, 'text/plain')
    }
...
def main():
    ...
    # Test file upload and chat
    results['upload'] = test_upload_file()
    
    # Wait for vector store to build
    print("\n⏳ Waiting 30 seconds for vector store to build...")
    time.sleep(30)
